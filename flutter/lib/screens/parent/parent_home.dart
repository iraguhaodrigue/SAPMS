...
class _ParentHomeState extends State<ParentHome> {
  ...
  Future<void> _loadChildData(String studentId) async {
    try {
      final results = await Future.wait([
        ApiService.getStudentAttendance(studentId, termId: 'term-2'),
        ApiService.getStudentReport(studentId, termId: 'term-2'),
      ]);
      setState(() {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('SAPMS Parent', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17)),
          Text('Child Progress Portal', style: TextStyle(fontSize: 11, color: Colors.white70)),
        ]),
        actions: [
      ...
      body: _loading
        ...
        : _children.isEmpty
          ? const Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              SizedBox(height: 12),
              Text('No children linked to your account', style: TextStyle(color: Colors.grey)),
            ]))
          : RefreshIndicator(
              onRefresh: _load,
  ...
  Widget _buildAttendanceSummary() {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      const Text('Attendance This Term', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
        ...
        Container(
          ...
          child: Row(children: [
            ...
            const Expanded(child: Text(
              'Attendance is below 85%. Please contact the school.',
              style: TextStyle(fontSize: 13, color: AppConstants.dangerColor),
            )),
          ]),
        ),
      ],
  ...
  Widget _buildAcademicReport() {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      const Text('Academic Performance', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
      const SizedBox(height: 10),
        ...
        return Container(
          ...
          child: Row(children: [
            ...
            if (avg != null) ...[
              ...
              const Text('No marks yet', style: TextStyle(color: Colors.grey, fontSize: 12)),
          ]),
        );
      }),
    ]);
